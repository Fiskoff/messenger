...
Revision ID: 4b0a085ea1cb
Revises: 
Create Date: 2025-03-27 17:17:31.682484
...
def upgrade() -> None:
    ...
    sa.Column('registration_date', sa.Date(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
